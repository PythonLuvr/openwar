...
import { REQUEST_PERMISSION_DEFINITION, requestPermissionExecutor } from "./request_permission.js";
...
export const NATIVE_TOOLS: ReadonlyMap<string, NativeTool> = new Map([
  ...
  ["request_permission",   { definition: REQUEST_PERMISSION_DEFINITION,   executor: requestPermissionExecutor }],
]);
